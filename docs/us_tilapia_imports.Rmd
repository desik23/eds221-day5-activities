...
subset_yearly_tilapia_tot_plot <- ggplot(data = subset_yearly_tilapia_tot, aes(x = year, y = value)) + geom_line() + labs(title = "Total US Tilapia Imports by Year") + xlab("Year") + ylab("Tilapia Imports Total Weights (in thousands of pounds)")
